...
stdlib.array.make.from_file ()
{
    ...
    stdlib.string.assert.is_char "${2}" || return 126;
...
stdlib.fn.args.require ()
{
    ...
    stdlib.array.assert.is_array _STDLIB_ARGS_NULL_SAFE || return 126;
...
stdlib.builtin.overridable trap stdlib.trap.handler.err.fn ERR
stdlib.builtin.overridable trap stdlib.trap.handler.exit.fn EXIT
