...
# @exitcode 0 If the mock is configured it can emit any exit code (default="0").
...
# @exitcode 0 If the mock call is persisted without problems.
# @internal
${1}.mock.__call() {
...
# @exitcode 0 If the controller command is successful.
