...
- To run a subset of the test suite:
  - `./container.sh run build/test.sh src/logger`

The script has several a couple of other useful commands that are helpful for working with docker and troubleshooting common problems.
