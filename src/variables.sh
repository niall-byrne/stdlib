...
# globals
builtin declare -x "STDLIB_LOCK_WORKSPACE=${STDLIB_LOCK_WORKSPACE:-}"
...
builtin declare "STDLIB_TRACEBACK_DISABLE_BOOLEAN=${STDLIB_TRACEBACK_DISABLE_BOOLEAN:-1}"
builtin declare "__STDLIB_SECURE_DISTRIBUTION=${__STDLIB_SECURE_DISTRIBUTION:-0}"
