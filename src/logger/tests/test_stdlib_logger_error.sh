...
test_stdlib_logger_error__default_prefix____correct_stderr() {
...
test_stdlib_logger_error__specified_prefix__correct_stderr() {
...
test_stdlib_logger_error__default_prefix____no_stdout() {
  TEST_EXPECTED=''
  TEST_INPUT="test string"
...
test_stdlib_logger_error__invalid_array_____correct_stderr() {
