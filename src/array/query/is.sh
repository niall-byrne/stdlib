...
# @arg $1 The value to query for.
# @arg $2 The name of the array to query.
...
# @exitcode 126 If either of the arguments is not an array.
# @exitcode 127 If the wrong number of arguments is provided.
...
# @arg $1 The name of the array to query.
