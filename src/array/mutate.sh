...
# @description Applies a function to each element of an array in place.
...
# @description Filters an array in place based on a predicate function.
# @arg $1 string The name of the predicate function.
# @arg $2 string The name of the array to modify.
# @exitcode 0 If the operation succeeded.
# @exitcode 126 If an invalid argument has been provided.
# @exitcode 127 If the wrong number of arguments were provided.
...
# @description Formats each element of an array in place using a printf format string.
...
# @arg $1 string The element to insert.
# @arg $2 integer The index at which to insert the element.
