...
@parametrize_with_success_outputs() {
  ...
  @parametrize \
    ...
    "valid_array_1;TEST_ARRAY_1;1" \
    "valid_array_2;TEST_ARRAY_2;1" \
    "valid_array_3;TEST_ARRAY_3;0"
}

test_stdlib_array_get_shortest__@vary__returns_expected_status_code() {
  local args=()
  stdlib.array.make.from_string args "|" "${TEST_ARGS}"

  _capture.rc stdlib.array.get.shortest "${args[@]}" > /dev/null
...
test_stdlib_array_get_shortest__@vary__logs_error() {
  local args=()
...
test_stdlib_array_get_shortest__@vary__returns_expected_output() {
  local args=()
  stdlib.array.make.from_string args "|" "${TEST_ARGS}"

  _capture.output stdlib.array.get.shortest "${args[@]}"
