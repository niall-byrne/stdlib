...
@parametrize_with_array_contents() {
  ...
  @parametrize \
    ...
    "simple_array__________one_char_string;a|simple_array;1a|2a|3a" \
    "complex_array_________one_char_string;a|complex_array;hello<br>therea|goodbye<br>therea" \
    "empty_array___________one_char_string;a|empty_array;;" \
    "simple_array__________complex_string_;a<br>z|simple_array;1a<br>z|2a<br>z|3a<br>z" \
    "complex_array_________complex_string_;a<br>z|complex_array;hello<br>therea<br>z|goodbye<br>therea<br>z" \
...
# shellcheck disable=SC2034
test_stdlib_array_mutate_append__@vary__returns_expected_status_code() {
  local args=()

  stdlib.array.make.from_string args "|" "${TEST_ARGS_DEFINITION}"

  _capture.rc stdlib.array.mutate.append "${args[@]}" > /dev/null
...
# shellcheck disable=SC2034
test_stdlib_array_mutate_append__@vary__updates_array_correctly() {
  local args=()
  ...
  stdlib.array.mutate.append "${args[@]}"
