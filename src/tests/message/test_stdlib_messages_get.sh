...
@parametrize_with_message_content() {
  ...
  @parametrize \
    ...
    "fn_name_invalid;FN_NAME_INVALID|my_func;The value 'my_func' is not a valid function name!" \
    ...
    "var_value_invalid_global;VAR_VALUE_INVALID_GLOBAL;A global variable has been assigned an invalid value!" \
    ...
    "var_value_invalid_reserved;VAR_VALUE_INVALID_RESERVED;A variable reserved for internal use by the BASH stdlib and has been assigned an invalid value!" \
...
@parametrize_with_incorrect_arg_counts() {
  ...
  @parametrize \
    ...
    "fn_name_invalid_________________________no_args______;FN_NAME_INVALID" \
    "fn_name_invalid_________________________too_many_args;FN_NAME_INVALID|1|2" \
    ...
    "var_value_invalid_global________________too_many_args;VAR_VALUE_INVALID_GLOBAL|1" \
    ...
    "var_value_invalid_reserved______________too_many_args;VAR_VALUE_INVALID_RESERVED|1" \
...
test_stdlib_message_update_get__@vary() {
  ...
  _capture.rc stdlib.__message.get "${args[@]}" > /dev/null
...
test_stdlib_message_update_get__valid_argument________________@vary_____returns_correct_message() {
  ...
  _capture.stdout stdlib.__message.get "${args[@]}"
...
test_stdlib_message_update_get__invalid_arguments_____________returns_error_message() {
  _capture.stdout stdlib.__message.get "NON_EXISTENT_KEY"
