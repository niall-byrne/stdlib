...
# shellcheck disable=SC2034
test_stdlib_io_lock_acquire__@vary__invalid_perms______returns_status_code_126() {
...
test_stdlib_io_lock_acquire__@vary__invalid_perms______logs_error_message() {
  ...
  stdlib.logger.error.mock.assert_calls_are \
    ...
    "1($(stdlib.__message.get VAR_VALUE_INVALID STDLIB_LOCK_PERMISSION_OCTAL))"
}
...
# shellcheck disable=SC2034
test_stdlib_io_lock_acquire__@vary__invalid_interval___returns_status_code_126() {
...
# shellcheck disable=SC2034
test_stdlib_io_lock_acquire__@vary__invalid_verbosity__returns_status_code_126() {
...
# shellcheck disable=SC2034
test_stdlib_io_lock_acquire__@vary__invalid_wait_time__returns_status_code_126() {
...
# shellcheck disable=SC2034
test_stdlib_io_lock_acquire__allocated_workspace_____valid_args_________validates_workspace() {
  local STDLIB_LOCK_WORKSPACE="mocked_workspace"
  local _STDLIB_BINARY_CHMOD="chmod"
  local _STDLIB_BINARY_MKDIR="mkdir"
...
# shellcheck disable=SC2034
test_stdlib_io_lock_acquire__allocated_workspace_____valid_args_________time_exceed______________no_call_to_chmod() {
  local SECONDS=0
  local STDLIB_LOCK_WAIT_SECONDS=0
  local STDLIB_LOCK_WORKSPACE="mocked_workspace"
  local _STDLIB_BINARY_CHMOD="chmod"
...
# shellcheck disable=SC2034
test_stdlib_io_lock_acquire__allocated_workspace_____valid_args_________acquired_________________perms_default_______calls_chmod_with_correct_args() {
  local SECONDS=0
  local STDLIB_LOCK_WAIT_SECONDS=10
  local STDLIB_LOCK_WORKSPACE="mocked_workspace"
  local _STDLIB_BINARY_MKDIR="mkdir"
...
# shellcheck disable=SC2034
test_stdlib_io_lock_acquire__allocated_workspace_____valid_args_________acquired_________________perms_custom________calls_chmod_with_correct_args() {
  local SECONDS=0
...
# shellcheck disable=SC2034
test_stdlib_io_lock_acquire__no_allocated_workspace__valid_args_________validates_workspace() {
  local STDLIB_LOCK_WORKSPACE="mocked_workspace"
  local _STDLIB_BINARY_MKDIR="mkdir"
...
# shellcheck disable=SC2034
test_stdlib_io_lock_acquire__no_allocated_workspace__valid_args_________no_call_to_chmod() {
  local STDLIB_LOCK_WORKSPACE="mocked_workspace"
  local _STDLIB_BINARY_CHMOD="chmod"
  local _STDLIB_BINARY_MKDIR="mkdir"
