...
@parametrize_with_arg_combos() {
  ...
  @parametrize \
    ...
    "failing_validator__valid_var_name____implicit_source;_mock_validator_fails|_TEST_VAR;1;VAR_VALUE_INVALID_GLOBAL_DETAIL|_TEST_VAR;125;ARGUMENTS_KEYWORD_INVALID" \
    ...
    "failing_validator__valid_var_name____name_source____;_mock_validator_fails|_TEST_VAR|name;1;VAR_VALUE_INVALID_GLOBAL_DETAIL|_TEST_VAR;125;ARGUMENTS_KEYWORD_INVALID" \
    ...
    "failing_validator__valid_var_name____value_source___;_mock_validator_fails|_TEST_VAR|value;1;VAR_VALUE_INVALID_GLOBAL_DETAIL|_TEST_VAR;125;ARGUMENTS_KEYWORD_INVALID" \
...
test_stdlib_var_global_assert_is_valid_with__no_kw_______@vary__returns_expected_status_code() {
  local args=()

  stdlib.array.make.from_string args "|" "${TEST_ARGS_DEFINITION}"

  _capture.rc stdlib.var.global.assert.is_valid_with "${args[@]}"
...
# shellcheck disable=SC2153
test_stdlib_var_global_assert_is_valid_with__no_kw_______@vary__logs_an_error() {
  local args=()
  local message_args=()
  ...
  stdlib.var.global.assert.is_valid_with "${args[@]}" > /dev/null
...
test_stdlib_var_global_assert_is_valid_with__invalid_kw__@vary__returns_expected_status_code() {
  local args=()
...
# shellcheck disable=SC2153
test_stdlib_var_global_assert_is_valid_with__invalid_kw__@vary__logs_an_error() {
  local args=()
  local message_args=()
