...
@parametrize_with_arg_combos() {
  ...
  @parametrize \
    ...
    "failing_validator__valid_var_name____implicit_source;_mock_validator_fails|_TEST_VAR;1;VAR_VALUE_INVALID_GLOBAL_DETAIL|_TEST_VAR;126;ARGUMENTS_INVALID" \
    ...
    "failing_validator__valid_var_name____name_source____;_mock_validator_fails|_TEST_VAR|name;1;VAR_VALUE_INVALID_GLOBAL_DETAIL|_TEST_VAR;126;ARGUMENTS_INVALID" \
    ...
    "failing_validator__valid_var_name____value_source___;_mock_validator_fails|_TEST_VAR|value;1;VAR_VALUE_INVALID_GLOBAL_DETAIL|_TEST_VAR;126;ARGUMENTS_INVALID" \
