...
# shellcheck disable=SC2034
test_stdlib_var_query_is_valid_with__valid_args________no_default__@vary__validator_passes__return_status_code___0() {
  _mock_validator.mock.set.rc 0
...
# shellcheck disable=SC2034
test_stdlib_var_query_is_valid_with__valid_args________no_default__@vary__validator_fails___validation_error__return_status_code___1() {
...
# shellcheck disable=SC2034
test_stdlib_var_query_is_valid_with__valid_args________no_default__@vary__validator_fails___validation_args___return_status_code_127() {
...
# shellcheck disable=SC2034
test_stdlib_var_query_is_valid_with__valid_args________default_____@vary__validator_passes__return_status_code___0() {
  _mock_validator.mock.set.rc 0
...
# shellcheck disable=SC2034
test_stdlib_var_query_is_valid_with__valid_args________default_____@vary__validator_fails___validation_error__return_status_code___1() {
  _mock_validator.mock.set.rc 1
...
# shellcheck disable=SC2034
test_stdlib_var_query_is_valid_with__valid_args________default_____@vary__validator_fails___validation_args___return_status_code_127() {
  _mock_validator.mock.set.rc 127
