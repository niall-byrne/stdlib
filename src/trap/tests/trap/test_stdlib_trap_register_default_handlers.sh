...
test_stdlib_trap_register_default_handlers__invalid_boolean_____returns_status_code_126() {
...
test_stdlib_trap_register_default_handlers__invalid_boolean_____logs_error_message() {
  ...
  stdlib.logger.error.mock.assert_calls_are \
    ...
    "1($(stdlib.__message.get VAR_VALUE_INVALID_RESERVED_DETAIL STDLIB_TRACEBACK_DISABLE_BOOLEAN))"
}

# shellcheck disable=SC2034
test_stdlib_trap_register_default_handlers__@vary__returns_status_code_126() {
...
test_stdlib_trap_register_default_handlers__@vary__logs_error_message() {
  ...
  stdlib.logger.error.mock.assert_calls_are \
    ...
    "1($(stdlib.__message.get VAR_VALUE_INVALID_RESERVED_DETAIL "${TEST_ARRAY_NAME}"))"
}
