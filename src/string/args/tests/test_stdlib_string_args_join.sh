...
@parametrize_with_arg_combos() {
  ...
  @parametrize \
    ...
    "valid_separator__no_input__________returns_status_code_127;|;127" \
...
@parametrize_with_expected_output() {
  ...
  @parametrize \
    ...
    "null_separator___and_white_space_;| input_string1 ; input_string1 " \
    "valid_separator__and_single_input;|input_string1;input_string1" \
    "valid_separator__and_white_space_;| input_string1 ; input_string1 "
}

# shellcheck disable=SC2034
test_stdlib_string_args_join__@vary() {
  local args=()
  ...
  _capture.rc stdlib.string.args.join "${args[@]}" > /dev/null
...
# shellcheck disable=SC2034
test_stdlib_string_args_join__@vary__generates_expected_output() {
  local args=()
  ...
  _capture.output stdlib.string.args.join "${args[@]}" > /dev/null
