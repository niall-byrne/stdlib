...
@parametrize_with_arg_combos() {
  ...
  @parametrize \
    ...
    "uppercase____________returns_status_code___1;ABCD_1234;1" \
...
@parametrize_with_error_messages() {
  ...
  @parametrize \
    ...
    "empty_string_______;|;IS_NOT_SNAKE_CASE||" \
    "trailing_underscore;abcd_1234_;IS_NOT_SNAKE_CASE|abcd_1234_"
}

# shellcheck disable=SC2034
test_stdlib_string_assert_is_snake_case__@vary() {
  local args=()
  _mock.create stdlib.logger.error

  stdlib.array.make.from_string args "|" "${TEST_ARGS_DEFINITION}"

  _capture.rc stdlib.string.assert.is_snake_case "${args[@]}" > /dev/null
...
test_stdlib_string_assert_is_snake_case__@vary__logs_an_error() {
  local args=()
  local message_args=()
  ...
  stdlib.string.assert.is_snake_case "${args[@]}"
