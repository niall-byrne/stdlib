...
@parametrize_with_arg_combos() {
  ...
  @parametrize \
    ...
    "single_neg_digit__returns_status_code___0;-3;0" \
...
@parametrize_with_error_messages() {
  ...
  @parametrize \
    ...
    "empty_string____;|;IS_NOT_DECIMAL||" \
    "alpha___________;aa;IS_NOT_DECIMAL|aa" \
    "alphanumeric____;aa011;IS_NOT_DECIMAL|aa011" \
    "too_many_dots___;1.1.1.1;IS_NOT_DECIMAL|1.1.1.1"
}

# shellcheck disable=SC2034
test_stdlib_string_assert_is_decimal__@vary() {
  local args=()
  _mock.create stdlib.logger.error

  stdlib.array.make.from_string args "|" "${TEST_ARGS_DEFINITION}"

  _capture.rc stdlib.string.assert.is_decimal "${args[@]}" > /dev/null
...
test_stdlib_string_assert_is_decimal__@vary__logs_an_error() {
  local args=()
  local message_args=()
  ...
  stdlib.string.assert.is_decimal "${args[@]}"
