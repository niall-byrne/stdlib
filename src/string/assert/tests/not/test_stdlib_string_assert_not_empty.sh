...
@parametrize_with_arg_combos() {
  ...
  @parametrize \
    ...
    "empty_string______returns_status_code___1;|;1" \
    "multiple_chars____returns_status_code___0;!2jfA0;0" \
    "symbol____________returns_status_code___0;@;0" \
    "alpha_____________returns_status_code___0;A;0" \
    "numeric___________returns_status_code___0;3;0"
}
...
@parametrize_with_error_messages() {
  ...
  @parametrize \
    ...
    "empty_string____;|;IS_EMPTY_STRING||" \
