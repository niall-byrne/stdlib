...
# @description Creates a directory and secures it with the specified ownership and permissions.
...
# @description Creates a file and secures it with the specified ownership and permissions.
