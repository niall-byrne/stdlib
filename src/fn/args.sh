...
# @arg $2 integer The number of optional arguments, a negative value indicates no upper limit.
...
stdlib.fn.args.require() {
  ...
  stdlib.string.assert.is_integer "${args_optional_count}" || builtin return 126
