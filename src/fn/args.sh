...
# @exitcode 126 If an invalid argument has been provided (e.g., a null value for a non-null-safe argument).
# @exitcode 127 If the number of arguments is incorrect.
