...
#   * __STDLIB_TESTING_MOCK_SEQUENCE_LOCK_NAME: This string identifies the lock file used to control locking during sequence tracking (default="__stdlib_testing_internal__mock_sequence_lock").
