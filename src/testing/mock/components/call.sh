...
#   * __STDLIB_TESTING_MOCK_SEQUENCE_TRACKING_BOOLEAN boolean global: This boolean determines whether sequence information will be persisted for this call (default="0").
# @arg $@ string The arguments the mock was called with.
# @exitcode 0 If the mock's call was persisted successfully.
# @internal
${1}.mock.__call() {
  # clean __${2}_mock_calls_file,__${2}_mock_keywords,__STDLIB_TESTING_MOCK_SEQUENCE_ARRAY
