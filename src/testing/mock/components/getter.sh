...
# @exitcode 0 If the command was applied successfully.
# @internal
...
# @exitcode 0 If the call was retrieved successfully.
...
# @noargs
# @exitcode 0 If all calls were retrieved successfully.
# @exitcode 127 If the wrong number of arguments were provided.
...
# @noargs
# @exitcode 0 If the call count was retrieved successfully.
# @exitcode 127 If the wrong number of arguments were provided.
...
# @noargs
# @exitcode 0 If the keywords were retrieved successfully.
# @exitcode 127 If the wrong number of arguments were provided.
