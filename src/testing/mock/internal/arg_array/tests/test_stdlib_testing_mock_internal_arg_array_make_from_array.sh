...
# shellcheck disable=SC2034
test_stdlib_testing_mock_internal_arg_array_make_from_array__string_keywords__@vary__produces_correct_result() {
  ...
  _mock.__internal.arg_array.make.from_array result_array positional_args keyword_args
...
# shellcheck disable=SC2034
test_stdlib_testing_mock_internal_arg_array_make_from_array__array_keywords___@vary__produces_correct_result() {
  local empty_array=()
  local expected_array=()
  local keyword_args=()
...
test_stdlib_testing_mock_internal_arg_array_make_from_array__no_args() {
  local empty_array=()
  local expected_array=()
  local result_array=()

  _mock.__internal.arg_array.make.from_array result_array empty_array
