...
test_stdlib_testing_mock_arg_string_make_from_string__valid_string__no_array___________invalid_keyword_______logs_expected_error() {
  _mock.create stdlib.testing.internal.logger.error
...
test_stdlib_testing_mock_arg_string_make_from_string__valid_string__valid_array________invalid_keyword_______logs_expected_error() {
  _mock.create stdlib.testing.internal.logger.error
...
test_stdlib_testing_mock_arg_string_make_from_string__valid_string__invalid_array______invalid_keyword_______logs_expected_error() {
  _mock.create stdlib.testing.internal.logger.error
