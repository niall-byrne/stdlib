...
@parametrize_with_reserved_arrays() {
  @parametrize \
    ...
    "functions_array____;__STDLIB_TESTING_PARAMETRIZE_GENERATED_FUNCTIONS_ARRAY;123"
}
...
test_parametrize_apply__api_test__invalid_scalar__@vary__returns_expected_status_code() {
...
# shellcheck disable=SC2034
test_parametrize_apply__api_test__invalid_scalar__@vary__logs_error_message() {
...
# shellcheck disable=SC2034
test_parametrize_apply__api_test__invalid_array___@vary__returns_expected_status_code() {
...
# shellcheck disable=SC2034
test_parametrize_apply__api_test__invalid_array___@vary__logs_expected_error() {
  declare "${TEST_ARRAY_KEYWORD_NAME}"
