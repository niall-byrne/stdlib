...
@parametrize_with_incorrect_args() {
  ...
  STDLIB_TESTING_PARAMETRIZE_SETTING_FIELD_SEPARATOR=';' @parametrize \
    ...
    "invalid_test_fn;invalid_test_fn|@parametrize_with_incorrect_arg;126;;PARAMETRIZE_ERROR_TEST_FN_INVALID|invalid_test_fn PARAMETRIZE_ERROR_TEST_FN_NAME|@vary" \
    "invalid_parametrizer;test_fn_mock_@vary|invalid_parametrizer;126;;PARAMETRIZE_ERROR_PARAMETRIZER_FN_INVALID|invalid_parametrizer PARAMETRIZE_ERROR_PARAMETRIZER_FN_NAME|@parametrize_with_" \
