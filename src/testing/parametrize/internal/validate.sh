...
#   * STDLIB_TESTING_PARAMETRIZE_SETTING_PREFIX string global: The required prefix for parametrizer functions (default="@parametrize_with_").
...
#   * STDLIB_TESTING_PARAMETRIZE_SETTING_VARIANT_TAG string global: The required tag in the test function name (default="@vary").
